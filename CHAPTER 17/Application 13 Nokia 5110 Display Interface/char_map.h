 ...
 * char_map.h
 *
 * Created: 22/12/2021 16:40:45
 *  Author: CosmaOne
 */ 

#include <avr/pgmspace.h>

#define CHAR_WIDTH	6 //Character pixel width.

#ifndef CHAR_MAP_H_
#define CHAR_MAP_H_

static const char CHAR_MAP[][CHAR_WIDTH] PROGMEM =
{
	...
	,{0x14, 0x36, 0x7F, 0x36, 0x14, 0x00} // 14 up + down arrow with joined tails
	...
	,{0x07, 0x05, 0x07, 0x00, 0x00, 0x00} // D0 degree symbol
	...
	//Custom characters.
	,{0x5B, 0x5B, 0x40, 0x5B, 0x5B, 0x55} // FE Hellenic flag (left part)
	,{0x55, 0x55, 0x55, 0x55, 0x55, 0x55} // FF Hellenic flag (right part)
};
